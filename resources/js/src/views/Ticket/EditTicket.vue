   ...
   <div  class="dashboard"> 
    ...
    <div class="list__page">
      <div v-if="successMessage" class="alert alert-success">
        ...
        <!-- <h4><i class="fas fa-ticket"></i> Edit Ticket </h4> -->
      
          <div class="page__breadcrumb">
     <p> <b-link :to="{ name: 'ticket' }" >Ticket <i class="fas fa-chevron-right"></i> </b-link>Edit</p>
    </div>
      ...
      <b-container fluid>
        <!-- <b-row>
          <b-col cols="12"> -->
            <!-- Sidebar-like form using a div with v-if -->
...
watch: {
 ...
 this.editTicket();
  ...
  try {
    ...
    if (customerId && this.decodeBase64(customerId) && this.decodeBase64(customerId) !== 0) {
      this.$router.push({ 
        name: 'view-customer', 
        params: { id: this.encodeBase64(this.decodeBase64(customerId)) } 
      });
    } else {
    ...
    submitTicket() {
      ...
      // this.errors = {};
      if (this.TicketData.id != null) {
        axios
          .put(`/tickets/${this.TicketData.id}`, this.TicketData)
          .then((response) => {
    ...
    editTicket(id) {
      ...
      axios.get(`/tickets/${this.$route.params.id}/edit`).then((response) => {
